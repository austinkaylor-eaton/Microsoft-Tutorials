...
# This script is used to configure the SQL Server database
# From -> https://github.com/dotnet/aspire-samples/blob/main/samples/DatabaseContainers/DatabaseContainers.AppHost/sqlserverconfig/configure-db.sh
# set -x
