-- Description: This script creates the database and tables for the sample application.
-- Version: 1.0
-- https://github.com/Azure-Samples/azure-sql-db-fusioncache/blob/main/data/SampleDB.sql
